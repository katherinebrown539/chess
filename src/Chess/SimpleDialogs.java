...
public class SimpleDialogs
{
   ...
   {
      //We need a fixed width font to display the results correctly
      Font fixed = new Font("Courier New",Font.PLAIN,12);
      try
      {
         //UIManager.setLookAndFeel(UIManager.getSystemLookAndFeelClassName());
         UIManager.getLookAndFeelDefaults().put("Label.font",fixed);
      }
      catch (Exception e)
      {
      }
