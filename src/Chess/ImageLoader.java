...
/**
	ImageLoader is a utility class that simplifies loading images into memory. 
	The ImageLoader object is obtained by calling getImageLoader and not a constructor. 
	To obtain an image from the ImageLoader, simply pass the file name of the image 
	to the getImage method.
*/
